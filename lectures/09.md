...
Proszę o implementację konceptów z `Ćw. 1.` oraz `Ćw. 2.`. Jeśli ktoś nie potrafi utworzyć wszystkich konceptów lub ma jakieś problemy/niedociągnięcia, proszę o wysłanie tego co jest i którki komentarz.